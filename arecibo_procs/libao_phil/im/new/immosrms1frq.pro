;-----------------------------------------------------------------------------
;immosrms1frq, hardcopy   - create mosaic of rms 1 freq
;-----------------------------------------------------------------------------
pro immosrms1frq,year,mon,day1,dohardcopy,_extra=e,freq=freq,nplts=nplts,$
            bpc=bpc,win=win,ver=ver
;
...
;
    ...
    immossetup,0,3,dohardcopy,mos,_extra=e
    ...
    for i=0,pltperpage-1 do begin
        ...
        yymmdd=(year mod 100) + month*100+i+day1+offset
        iminpday,yymmdd,d
        imgfrq,d,freq,dfrq
        if (bpc ne 0 ) then imbpc1,dfrq
        immosrms1,dfrq,freq,curcol,currow,mos,dohardcopy,ver=ver
