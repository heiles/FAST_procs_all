function tdata_guess_2016, m_tot, qsrc, usrc, vsrc, sigdata, $
...
guess2[ 0, nrow]= sigdata[nrow]*(m_tot[0, nrow] + vsrc* m_tot[3, nrow])
guess2[ 1, nrow]= sigdata[nrow]*(qsrc*m_tot[1, nrow] + usrc*m_tot[2, nrow])
guess2[ 2, nrow]= sigdata[nrow]*(usrc*m_tot[1, nrow] - qsrc*m_tot[2, nrow])
endfor
