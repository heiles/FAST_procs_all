pro guess_tot_st, coeffs_out, guess_tot, m_tot, pacoeffs=pacoeffs
...
;	elements, used for the least squares program mm_genfit.
;
; OUTPUTS:
...
guess_tot= tdata_guess( m_tot, coeffs_out.qsrc, coeffs_out.usrc, $
        coeffs_out.vsrc, pacoeffs=pacoeffs                      )
