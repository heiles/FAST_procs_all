...
;
; where does 2.34 come from?
; etamb= omegaMB/omegaBm   
; lambda^2= Ae*omegaBm   effective area
; Ae=2761*kperjy
; so etamb = 2761 * kperjy * omegaMB
;           ----------------
;            lambda^2
; need to convert omegaMB arcmin^2 to rd^2 and lambda from cm to m
;  a=2761 ( 1./(57.2958*60.))^2 * omegaMB
;    ====================================   = 2.34..
;        1e-4
;             
