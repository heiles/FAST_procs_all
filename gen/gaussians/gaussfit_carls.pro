...
;
;   ITMAX: max nr of interations, default is 20
;
...
Function Gaussfit, x, y, a, $
    ...
    NTERMS=nt, $
    SIGMA=sigma, $
    YERROR=yerror, itmax=itmax, iter=iter, status=status
    ...
    yfit = CURVEFIT(x,y,weights,a,sigma, $
        ...
        FUNCTION_NAME = "GAUSS_FUNCT", $
        itmax=itmax, iter=iter, status=status) ;call curvefit
