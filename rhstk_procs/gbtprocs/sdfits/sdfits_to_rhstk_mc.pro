...
pro sdfits_to_rhstk_mc, filesin, BINDOWN=bindown, PSWITCH=pswitch, outpath=outpath
;+
; NAME:
;       SDFITS_TO_RHSTK
;
...
;                  then plotspider, pattern
      ...
      case 1 of
         ...
         keyword_set(PSWITCH) : SaveFreqPosSwitch_rhstk_mc,DataArr,path_filename
         keyword_set(FSWITCH) : SaveFreqPosSwitch_rhstk_mc,DataArr,path_filename
