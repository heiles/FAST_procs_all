...
;       Documentation incorrectly listed outputs as being returned in
;       degrees; they are returned in radians. T. Robishaw Sep 2006
;-

pro WCS_GETPOLE, crval, lonpole, theta0, alpha_p, delta_p, LATPOLE = latpole
          
; check to see that enough parameters were sent
...
; If THETA0 = 0 then CRVAL gives the coordinates of the origin in the
; native system.  This must be converted (using Eq. 7 in Calabretta &
; Greisen with theta0 = 0) to give the coordinates of the North pole
; (alpha_p, delta_p)
