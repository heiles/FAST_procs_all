pro z16hdrdef_a2470, successful, stokesc1, stokesc1_w, board, b_all, b, $
...
;
;   13may10: klt copied this file from ~heiles/idlzmn/z16hdrdef_sep00.pro and changed the call getrcvr to getrcvr_a2470 to correct MM corrections are made.
...
getrcvr_a2470, b, rcvr_name, rcvrn, mmprocname=mmprocname   ;RECEIVER NUMBER
