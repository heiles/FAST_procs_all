...
; ROBISHAW NEEDS TO PUT THIS HERE IN THE TRANSLATION TABLE...
	[ '\int', 		'i'   ,	 string(byte(242))  ],$
	...
	[ '\circ', 		"%"   ,	 string(byte(176))  ],$
        ; ROBISHAW ADDS THESE AASTEX COMMANDS...
	[ '\arcdeg', 		"%"   ,	 string(byte(176))  ],$
	[ '\arcmin',            "'"  ,	 string(byte(162))  ],$
	[ '\arcsec',            '"'  ,	 string(byte(178))  ]$
	                  ]
    LowercaseGreek(1,*) = $
