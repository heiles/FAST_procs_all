...
pro TR_RDPLOT, x, y, WaitFlag, DATA=Data, DEVICE=Device, NORMAL=Normal, $
...
;
; CALLING SEQUENCE:
;   TR_RDPLOT [, X, Y] [, WaitFlag] [, /DATA | /DEVICE | /NORMAL]
...
;
;   If a data coordinate system has not been established, then TR_RDPLOT
...
;   since TR_RDPLOT makes use of the OPLOT procedure.  This new data
...
;      small fix, now works. Changed name from RDPLOT to TR_RDPLOT---it was
;      too much to assume that users would know how to place the Goddard
;      path ahead of the IDL path.  T. Robishaw  2007 Jul 03
