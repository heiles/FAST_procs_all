...
;sky and having a healthy range of parallactic angles, and least square fit
...
;parameters divided by X+Y, and PA is the parallactic angle on the sky. 
...
;fractional polarizations, so that all xpy = unity and the rest are
;divided by xpy.
;
...
;
;MODIFICATION HISTORY: Jun 2013, CH lsfitted xpy so that its pacoeffs
;values aren't exactly 1,0,0. shouldn't matter down the line,k and this
;makes the routine work whether or not things are normalized to xpy.
;-
...
lsfitpa_allcal, qpa, xpy, sigmalimit, icoeffs, sigma, fittedpointsi
pacoeffs[ *, *, 0] = icoeffs
