...
;    fname='/home/phil/idl/test/data/fluxsrc.dat'
	...
	if (salter) then polPercent=strarr(1000)
...
;
                ...
                if salter then begin
                    ...
                    if nelm  gt ii then begin
                        polPercent[i]=strmid(inpline,ind[ii],len[ii])
                    endif else begin
                        polPercent[i]=' '
                    endelse
                    ii=ii+1
                    ...
                    fluxdata[i].rise=float(strmid(inpline,ind[ii],len[ii]))
                    ii=ii+1
                    fluxdata[i].set=float(strmid(inpline,ind[ii],len[ii]))
                    ii=ii+1

                    fluxdata[i].widths[0]=float(strmid(inpline,ind[ii],len[ii]))
                    ii=ii+1
                    fluxdata[i].widths[1]=float(strmid(inpline,ind[ii],len[ii]))
                    ii=ii+1
                    if nelm  gt ii then begin
                        fluxdata[i].notes=strmid(inpline,ind[ii],$
                                    1+strlen(inpline)-ind[ii])
