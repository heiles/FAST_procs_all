pro mm4, path, inputfilename, muellerparams_init, $
...
;muellerparams0.fixpsi=1
;muellerparams0.psi=0.
;stop
...
pltfilename, indx, a, inputfilename, 'm4', '.ps', title, plotfilename
nrps=1
...
m5plot, path, inputfilename, indx, a, muellerparams_chnls, /ps
...
;mm4name = path + 'mm4_' + 'bd' + string(a[ indx[0]].brd, $
;	format='(i1)') + '_' + a[ indx[0]].srcname + $
;	strmid( inputfilename, strpos( inputfilename, '.'))
mm4name = path+'mm4_'+(strsplit(plotfilename,'.ps',/REGEX,/EXTRACT))[0]+'.sav.sav'
