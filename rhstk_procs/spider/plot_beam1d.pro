pro plot_beam1d, nrc, board, beamin_arr, beamout_arr
...
centerfreq = beamin_arr[ nrc].cfr
currentscan = beamin_arr[ nrc].scannr
srcname =  beamout_arr[ nrc].sourcename
...
;;nr4 = offscans[ 1] - offscans[ 0]
;nr2 = max( indxcaloff) + 1
...
plot, totoffset[ *, nr], stokesoffset_cont[ nrstokes, *, nr], $
	xtit = 'OFFSET, ARCMIN', xsty=3, $
	ytit = labelnumber[ nrstokes], yrange = [plotmin, plotmax], ysty=19, $
	psym=4, background=!gray, color=!black, charsize=1.8, $
