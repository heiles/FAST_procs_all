...
;+
; NAME: rgbimg_st -- make rbg image with colorsquare-type colorbar
;
; PURPOSE:
; display rgb image with colorsquare-type colorbar. image must be 541 by
; 541 pixels. EXACTLY like RGBIMG.pro except that inputs are structures,
; which makes it easier to swap colors.
;
; CALLING SEQUENCE:
;rgbimg, $
;redtitle, redlabel1, redlabel2, redpwr, reddata, $
...
;18nov 2007: carl added documentation
;-
