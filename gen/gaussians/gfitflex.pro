pro gfitflex, look, xdataa, tdataa, xrange, zro0, hgt0, cen0, wid0, $
	zro0yn, hgt0yn, cen0yn, wid0yn, $
	tfita, sigma, zro1, hgt1, cen1, wid1, $
	sigzro1, sighgt1, sigcen1, sigwid1, cov, problem, quiet=quiet
;+
;NAME:
...
;
;CALLING SEQUENCE:
;    GFITFLEX, look, xdata, tdata, xrange, zro0, hgt0, cen0, wid0, $
;	zro0yn, hgt0yn, cen0yn, wid0yn, $
...
sfull[0, *] = 1. + fltarr(datasize) ;THE CONSTANT
...
for ng = 0, ngaussians-1 do begin
    ...
    sfull[(3*ng+1), *] = sum1          ;HGT
    sfull[(3*ng+2), *] = sum2*sum6     ;CNTR
    sfull[(3*ng+3), *] = sum3*sum6     ;WIDTH
...
gcurv, xdataa, zro1, hgt1, cen1, wid1, tfita
